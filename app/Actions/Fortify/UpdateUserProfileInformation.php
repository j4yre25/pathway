...
class UpdateUserProfileInformation implements UpdatesUserProfileInformation
{
    ...
    public function update(User $user, array $input): void
    {
        Validator::make($input, [
            ...
            'institution_contact_number' => ['nullable', 'string', 'max:20'],
        ...
        if ($input['email'] !== $user->email && $user instanceof MustVerifyEmail) {
            ...
            $user->forceFill([
                ...
                'company_contact_number' => $input['company_contact_number'] ?? $user->company_contact_number,
                ...
                'institution_contact_number' => $input['institution_contact_number'] ?? $user->institution_contact_number,
